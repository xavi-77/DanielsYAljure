        ...
        if (response) {
          ...
          for (let i = 0; i < Object.keys(response).length; i++) {
            ...
            this.dataTable.dataRows.push(
              [suma, response[i].radicado_DEMANDA,response[i].persona.nombres_PERSONA+' '+response[i].persona.p_Apellido_PERSONA,response[i].abogado.nombres_ABOGADO+' '+response[i].abogado.p_Apellido_ABOGADO, response[i].tipo_DEMANDA, response[i].especialida_DEMANDA,response[i].juzgado_Origen_DEMANDA, '/demanda/a8eb56ac895796852576a2294df407e94fe0eb34a2ff5774e3f66a46119b7ba4ab2329c6630a8623ac862b2ce48e8adf151fb4278f24a820651cb937b7f8733f/' + response[i].idDemandas , response[i].idDemandas , '/demanda/5216aab0d87c9b0c204df7fbacc093ce9bce5e110e94311c14ee1fa9cc08badd94d661af3d1b8c4f37b7606353c3332e6dedc5a1577cef4b58e8f771d87d3f05/' + response[i].idDemandas]
              )
          }
